...
namespace BLL
{
    public class TaiKhoanBLL
    {
        ...
        public string Insert_GioHang(DonHang donhang)
        {
            if (donhang.Ma_Don_Hang == "" || donhang.Ma_Khach_Hang == "")
            {
                return "botrong";
            }
            string info = tkAccess.CheckInsertGioHang(donhang);
            return info;
        }
        ...
        public string PhuTrach_DonHang(DonHang donhang)
        {
            if (donhang.Ma_Don_Hang == "" || donhang.Ma_Khach_Hang == "" | donhang.Ma_Nhan_Vien == "")
            {
                return "botrong";
            }
            else if (donhang.Ma_Nhan_VienGH != "")
            {
                return "exist";
            }
            string info = tkAccess.CheckPhuTrachDonHang(donhang);
            return info;
        }
        ...
        {
            //Kiểm tra nghiệp vụ
            if (nhanVien.Ten_Nhan_Vien == "")
            {
                return "requeid_tennhanvien";
            }
            else if (Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"\d") || Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"[,.!@#$%^&*()<>/|}{~:]"))
            {
                return "wrong_name";
            }
        ...
        public string CheckUpdateShipper(NhanVien nhanVien)
        {
            ...
            else if (nhanVien.Ten_Nhan_Vien == "")
            {
                return "requeid_tennhanvien";
            }
            else if (Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"\d") || Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"[,.!@#$%^&*()<>/|}{~:]"))
        ...
        public string CapNhat_MKThanhCong(NhanVien nhanvien)
        {
            if (nhanvien.MatKhau == "" || nhanvien.XacNhanMatKhau == "")
            {
                return "requeid_botrong";
            }
            else if (!Regex.IsMatch(nhanvien.MatKhau, @"[!@#$%^&*()<>/|}{~:]"))
            ...
            {
                return "requeid_short";
            }
            else if (nhanvien.MatKhau != nhanvien.XacNhanMatKhau)
            {
                return "requeid_khongbang";
            }
            string info = tkAccess.CapNhatMKThanhCong123(nhanvien);
            return info;
        }
        ...
        public string UpdateProFileNhanVien(NhanVien nhanVien)
        {
            //Kiểm tra nghiệp vụ
            if (nhanVien.Ma_Nhan_Vien == "" || nhanVien.Ten_Nhan_Vien == "" || nhanVien.Email == "" || nhanVien.GioiTinh == "" || nhanVien.DiaChi == "")
            {
                return "requeid_botrong";
            }
            else if (Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"\d") || Regex.IsMatch(nhanVien.Ten_Nhan_Vien, @"[,.!@#$%^&*()<>/|}{~:]"))
            ...
            string info = tkAccess.UpdateProfileNhanVien123(nhanVien);
            return info;
        }
        public string Change_PassFGNhanVien(NhanVien nhanVien)
        {
            //Kiểm tra nghiệp vụ
            ...
            string info = tkAccess.ChangePassNhanVien123(nhanVien);
            return info;
        }
        public string Find_PassNhanVien(NhanVien nhanVien)
        {
            //Kiểm tra nghiệp vụ
            if (nhanVien.Email == "")
            {
            ...
            string info = tkAccess.FindPassNhanVien123(nhanVien);
            return info;
        }

        public string Check_ExistGH(DonHang donHang)
        {
            string info = tkAccess.CheckExistGH(donHang);
            return info;
        }
